...
public class NoiseGenerator {
     ...
     *
     * @param seed       can be anything you want (even 1234 or new
     *                   Random().nextGaussian()).
     ...
     *                   In our case it should be your ground height at X0
     *                   (specified in
    ...
    /**
     * Noise is responsible to generate pseudo random noise according to the seed
     * given upon constructing the object.
     *
     * @param x      the wanted x to receive noise for (in our case, the x
     *               coordinate of the terrain you'd want to create).
     * @param factor describes how large the noise should be (play with it, but
     *               BLOCK_SIZE *7 should be enough).
